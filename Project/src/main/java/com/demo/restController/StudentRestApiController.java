...
public class StudentRestApiController {
	...
	@PatchMapping("/student/update/{id}/enable")
	public void updateParticularField(@PathVariable Integer id, @RequestBody Student std) {
		Student s =studentService.getStudentByIdRest(id);
		s.setPassword(encryptThisString(std.getPassword()));
		studentService.updateStudent(s);
	}
